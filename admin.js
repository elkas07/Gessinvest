...
// ---------------------------
// FONCTIONS DE GESTION DU TABLEAU DE BORD (inchangé)
// ---------------------------
...
// ---------------------------
// NOUVELLE LOGIQUE DE CONNEXION ET DE SÉCURITÉ
// ---------------------------
...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    else if (window.location.pathname.endsWith('admin.html') || window.location.pathname.endsWith('admin.js')) {
